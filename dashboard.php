				...
				<div class="card">
					<div class="card-body" >
						<form action="" method="post">
							<input type="text" name="search" placeholder="Cari berdasarkan NIM" class="form-control" style= " color : pink;width: 20%">
							<input type="submit" name="submit" value="Cari"class="btn btn-success"  style="color : red;width: 20%; margin: 5px 0 0 0">
						</form>
